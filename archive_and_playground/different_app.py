...
def main():
    ...
    if upload_type == "Single Image":
        ...
        if uploaded_image is not None and train_images and train_labels:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                for idx, image_path in enumerate(image_files):
                    with open(image_path, "rb") as f:
                        prediction = predict_image(learn, f)
                        pred_class, _, confidence_scores = prediction # Unpack prediction tuple
                        confidence_score = confidence_scores[1].item()
